...
// есть select с названиями тегов, textarea и кнопка. 
// При нажатии кнопки создавать выбранный в select тег, добавлять в него текстовое содержимое из textarea. 
// Если в textarea есть текст, то создавать элемент так же при переключении select
var elem,
